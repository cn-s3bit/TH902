...
class Time
{
	...
	public static void Update()
	{
		...
		if (Main.Available)
		{
			if (GE.Count < total)
			{
				for (int i = 0; i < total - GE.Count; i++)
				{
		...
		ArrayList<Layer>.Enumerator enumerator;
		...
		if ((Main.mousestate.LeftButton == Microsoft.Xna.Framework.Input.ButtonState.Pressed) & (Main.prostate.LeftButton != Microsoft.Xna.Framework.Input.ButtonState.Pressed))
		{
				...
				if (!Pause)
				{
					...
					try
					{
						while (enumerator.MoveNext())
						{
							...
							enumerator2 = current.BatchArray.GetEnumerator();
							...
							try
							{
								while (enumerator2.MoveNext())
								{
									...
									{
										current2.copys.fx = Player.position.X;
									}
									...
									{
										current2.copys.fy = Player.position.Y;
									}
									if (current2.speedd == -99999f)
									{
										current2.copys.speedd = MathHelper.ToDegrees(Main.Twopointangle(Player.position.X, Player.position.Y, current2.copys.fx, current2.copys.fy));
									}
									if (current2.aspeedd == -99999f)
									{
										current2.copys.aspeedd = MathHelper.ToDegrees(Main.Twopointangle(Player.position.X, Player.position.Y, current2.copys.fx, current2.copys.fy));
									}
									current2.copys.aspeed += num3;
									current2.copys.aspeedd += (float)num4;
									current2.copys.speed += num;
									current2.copys.speedd += (float)num2;
									current2.copys.aspeedx = current2.copys.aspeed * (float)Math.Cos((double)MathHelper.ToRadians(current2.copys.aspeedd));
									current2.copys.aspeedy = current2.copys.aspeed * (float)Math.Sin((double)MathHelper.ToRadians(current2.copys.aspeedd));
									current2.copys.speedx = current2.copys.speed * (float)Math.Cos((double)MathHelper.ToRadians(current2.copys.speedd));
									current2.copys.speedy = current2.copys.speed * (float)Math.Sin((double)MathHelper.ToRadians(current2.copys.speedd));
									...
									{
										current2.copys.fdirection = MathHelper.ToDegrees(Main.Twopointangle(current2.x - 4f, current2.y + 16f, current2.copys.fx, current2.copys.fy));
									}
									else if (current2.fdirection == -99999f)
									{
										current2.copys.fdirection = MathHelper.ToDegrees(Main.Twopointangle(Player.position.X, Player.position.Y, current2.copys.fx, current2.copys.fy));
									}
									else if (current2.fdirection == -100000f)
									{
										current2.copys.fdirection = MathHelper.ToDegrees(Main.Twopointangle(current2.fdirections.X, current2.fdirections.Y, current2.copys.fx, current2.copys.fy));
									}
									if (current2.sonaspeedd == -99998f)
									{
										current2.copys.sonaspeedd = MathHelper.ToDegrees(Main.Twopointangle(current2.x - 4f, current2.y + 16f, current2.copys.fx, current2.copys.fy));
									}
									else if (current2.sonaspeedd == -99999f)
									{
										current2.copys.sonaspeedd = MathHelper.ToDegrees(Main.Twopointangle(Player.position.X, Player.position.Y, current2.copys.fx, current2.copys.fy));
									}
									else if (current2.sonaspeedd == -100000f)
									{
										current2.copys.sonaspeedd = MathHelper.ToDegrees(Main.Twopointangle(current2.sonaspeedds.X, current2.sonaspeedds.Y, current2.copys.fx, current2.copys.fy));
									}
									if (current2.head == -100000f)
									{
										current2.copys.head = MathHelper.ToDegrees(Main.Twopointangle(current2.heads.X, current2.heads.Y, current2.copys.fx, current2.copys.fx));
									}
												...
												while (enumerator4.MoveNext())
												{
													...
													if (current5.Contains("变化到"))
													{
														...
														if (array[0].Replace("化到", "").Contains('+'))
														{
															...
															{
																res = float.Parse(array[0].Replace("化到", "").Split('+')[0]);
															}
														}
														...
														{
															res = float.Parse(array[0].Replace("化到", ""));
														}
														text4 = array[1];
														...
														if (array[0].Replace("化到", "").Contains('+'))
														{
															eventRead.rand = float.Parse(array[0].Replace("化到", "").Split('+')[1]);
														}
													...
													else if (current5.Contains("增加"))
													{
														...
														if (array2[0].Contains('+'))
														{
															...
															{
																res = float.Parse(array2[0].Split('+')[0]);
															}
														}
														else if (array2[0] == "自身")
														{
														...
														if (array2[0].Contains('+'))
														{
															eventRead2.rand = float.Parse(array2[0].Split('+')[1]);
														}
													...
													else if (current5.Contains("减少"))
													{
														...
														if (array3[0].Contains('+'))
														{
															...
															{
																res = float.Parse(array3[0].Split('+')[0]);
															}
														}
														else if (array3[0] == "自身")
														{
														...
														if (array3[0].Contains('+'))
														{
															eventRead3.rand = float.Parse(array3[0].Split('+')[1]);
														}
												...
												while (enumerator4.MoveNext())
												{
													...
													if (current7.Contains("变化到"))
													{
														...
														if (array4[0].Replace("化到", "").Contains('+'))
														{
															...
															{
																res2 = float.Parse(array4[0].Replace("化到", "").Split('+')[0]);
															}
														}
														...
														{
															res2 = float.Parse(array4[0].Replace("化到", ""));
														}
														text9 = array4[1];
														...
														if (array4[0].Replace("化到", "").Contains('+'))
														{
															eventRead6.rand = float.Parse(array4[0].Replace("化到", "").Split('+')[1]);
														}
													...
													else if (current7.Contains("增加"))
													{
														...
														if (array5[0].Contains('+'))
														{
															...
															{
																res2 = float.Parse(array5[0].Split('+')[0]);
															}
														}
														else if (array5[0] == "自身")
														{
														...
														if (array5[0].Contains('+'))
														{
															eventRead7.rand = float.Parse(array5[0].Split('+')[1]);
														}
													...
													else if (current7.Contains("减少"))
													{
														...
														if (array6[0].Contains('+'))
														{
															...
															{
																res2 = float.Parse(array6[0].Split('+')[0]);
															}
														}
														else if (array6[0] == "自身")
														{
														...
														if (array6[0].Contains('+'))
														{
															eventRead8.rand = float.Parse(array6[0].Split('+')[1]);
														}
							...
							try
							{
								while (enumerator5.MoveNext())
								{
									...
									current8.copys.aspeedx = current8.copys.aspeed * (float)Math.Cos((double)MathHelper.ToRadians(current8.copys.aspeedd));
									current8.copys.aspeedy = current8.copys.aspeed * (float)Math.Sin((double)MathHelper.ToRadians(current8.copys.aspeedd));
									current8.copys.speedx = current8.copys.speed * (float)Math.Cos((double)MathHelper.ToRadians(current8.copys.speedd));
									current8.copys.speedy = current8.copys.speed * (float)Math.Sin((double)MathHelper.ToRadians(current8.copys.speedd));
									if (current8.fdirection == -99999f)
									{
										current8.copys.fdirection = MathHelper.ToDegrees(Main.Twopointangle(Player.position.X, Player.position.Y, current8.copys.x - 4f, current8.copys.y + 16f));
									}
									else if (current8.fdirection == -100000f)
									{
										current8.copys.fdirection = MathHelper.ToDegrees(Main.Twopointangle(current8.fdirections.X, current8.fdirections.Y, current8.copys.x - 4f, current8.copys.y + 16f));
									}
									if (current8.sonaspeedd == -99998f)
									{
										current8.copys.sonaspeedd = MathHelper.ToDegrees(Main.Twopointangle(current8.x - 4f, current8.y + 16f, current8.copys.x - 4f, current8.copys.y + 16f));
									}
									else if (current8.sonaspeedd == -99999f)
									{
										current8.copys.sonaspeedd = MathHelper.ToDegrees(Main.Twopointangle(Player.position.X, Player.position.Y, current8.copys.x - 4f, current8.copys.y + 16f));
									}
									else if (current8.sonaspeedd == -100000f)
									{
										current8.copys.sonaspeedd = MathHelper.ToDegrees(Main.Twopointangle(current8.sonaspeedds.X, current8.sonaspeedds.Y, current8.copys.x - 4f, current8.copys.y + 16f));
									}
												...
												while (enumerator4.MoveNext())
												{
													...
													if (current11.Contains("变化到"))
													{
														...
														if (array7[0].Contains('+'))
														{
															...
															{
																res3 = float.Parse(array7[0].Split('+')[0]);
															}
														}
														else if (array7[0] == "自机")
														{
														...
														if (array7[0].Contains('+'))
														{
															eventRead9.rand = float.Parse(array7[0].Split('+')[1]);
														}
													...
													else if (current11.Contains("增加"))
													{
														...
														if (array8[0].Contains('+'))
														{
															...
															{
																res3 = float.Parse(array8[0].Split('+')[0]);
															}
														}
														else if (array8[0] == "自机")
														{
														...
														if (array8[0].Contains('+'))
														{
															eventRead10.rand = float.Parse(array8[0].Split('+')[1]);
														}
													...
													else if (current11.Contains("减少"))
													{
														...
														if (array9[0].Contains('+'))
														{
															...
															{
																res3 = float.Parse(array9[0].Split('+')[0]);
															}
														}
														else if (array9[0] == "自机")
														{
														...
														if (array9[0].Contains('+'))
														{
															eventRead11.rand = float.Parse(array9[0].Split('+')[1]);
														}
												...
												while (enumerator4.MoveNext())
												{
													...
													if (current13.Contains("变化到"))
													{
														...
														if (array10[0].Contains('+'))
														{
															...
															{
																res4 = float.Parse(array10[0].Split('+')[0]);
															}
														}
														...
														if (array10[0].Contains('+'))
														{
															eventRead14.rand = float.Parse(array10[0].Split('+')[1]);
														}
													...
													else if (current13.Contains("增加"))
													{
														...
														if (array11[0].Contains('+'))
														{
															...
															{
																res4 = float.Parse(array11[0].Split('+')[0]);
															}
														}
														...
														if (array11[0].Contains('+'))
														{
															eventRead15.rand = float.Parse(array11[0].Split('+')[1]);
														}
													...
													else if (current13.Contains("减少"))
													{
														...
														if (array12[0].Contains('+'))
														{
															...
															{
																res4 = float.Parse(array12[0].Split('+')[0]);
															}
														}
														...
														if (array12[0].Contains('+'))
														{
															eventRead16.rand = float.Parse(array12[0].Split('+')[1]);
														}
							...
							try
							{
								while (enumerator6.MoveNext())
								{
									...
									current14.copys.aspeedx = current14.copys.aspeed * (float)Math.Cos((double)MathHelper.ToRadians(current14.copys.aspeedd));
									current14.copys.aspeedy = current14.copys.aspeed * (float)Math.Sin((double)MathHelper.ToRadians(current14.copys.aspeedd));
									current14.copys.speedx = current14.copys.speed * (float)Math.Cos((double)MathHelper.ToRadians(current14.copys.speedd));
									current14.copys.speedy = current14.copys.speed * (float)Math.Sin((double)MathHelper.ToRadians(current14.copys.speedd));
												...
												while (enumerator4.MoveNext())
												{
													...
													if (current17.Contains("变化到"))
													{
														...
														if (array13[0].Contains('+'))
														{
															...
															{
																res5 = float.Parse(array13[0].Split('+')[0]);
															}
														}
														...
														if (array13[0].Contains('+'))
														{
															eventRead17.rand = float.Parse(array13[0].Split('+')[1]);
														}
													...
													else if (current17.Contains("增加"))
													{
														...
														if (array14[0].Contains('+'))
														{
															...
															{
																res5 = float.Parse(array14[0].Split('+')[0]);
															}
														}
														...
														if (array14[0].Contains('+'))
														{
															eventRead18.rand = float.Parse(array14[0].Split('+')[1]);
														}
													...
													else if (current17.Contains("减少"))
													{
														...
														if (array15[0].Contains('+'))
														{
															...
															{
																res5 = float.Parse(array15[0].Split('+')[0]);
															}
														}
														...
														if (array15[0].Contains('+'))
														{
															eventRead19.rand = float.Parse(array15[0].Split('+')[1]);
														}
												...
												while (enumerator4.MoveNext())
												{
													...
													if (current19.Contains("变化到"))
													{
														...
														if (array16[0].Contains('+'))
														{
															...
															{
																res6 = float.Parse(array16[0].Split('+')[0]);
															}
														}
														...
														if (array16[0].Contains('+'))
														{
															eventRead20.rand = float.Parse(array16[0].Split('+')[1]);
														}
													...
													else if (current19.Contains("增加"))
													{
														...
														if (array17[0].Contains('+'))
														{
															...
															{
																res6 = float.Parse(array17[0].Split('+')[0]);
															}
														}
														...
														if (array17[0].Contains('+'))
														{
															eventRead21.rand = float.Parse(array17[0].Split('+')[1]);
														}
													...
													else if (current19.Contains("减少"))
													{
														...
														if (array18[0].Contains('+'))
														{
															...
															{
																res6 = float.Parse(array18[0].Split('+')[0]);
															}
														}
														...
														if (array18[0].Contains('+'))
														{
															eventRead22.rand = float.Parse(array18[0].Split('+')[1]);
														}
							...
							try
							{
								while (enumerator7.MoveNext())
								{
									...
									current20.copys.aspeedx = current20.copys.aspeed * (float)Math.Cos((double)MathHelper.ToRadians(current20.copys.aspeedd));
									current20.copys.aspeedy = current20.copys.aspeed * (float)Math.Sin((double)MathHelper.ToRadians(current20.copys.aspeedd));
									current20.copys.speedx = current20.copys.speed * (float)Math.Cos((double)MathHelper.ToRadians(current20.copys.speedd));
									current20.copys.speedy = current20.copys.speed * (float)Math.Sin((double)MathHelper.ToRadians(current20.copys.speedd));
								}
							}
							finally
							{
							...
							try
							{
								while (enumerator8.MoveNext())
								{
									...
									current21.copys.aspeedx = current21.copys.aspeed * (float)Math.Cos((double)MathHelper.ToRadians(current21.copys.aspeedd));
									current21.copys.aspeedy = current21.copys.aspeed * (float)Math.Sin((double)MathHelper.ToRadians(current21.copys.aspeedd));
									current21.copys.speedx = current21.copys.speed * (float)Math.Cos((double)MathHelper.ToRadians(current21.copys.speedd));
									current21.copys.speedy = current21.copys.speed * (float)Math.Sin((double)MathHelper.ToRadians(current21.copys.speedd));
								}
							}
							finally
							{
			...
			else if (Aim3)
			{
				...
				try
				{
					...
					{
						GlobalEvent current32 = enumerator9.Current;
						current32.gtcount = 0;
						current32.qtcount = 0;
						current32.stcount = 0;
					}
				...
				try
				{
					while (enumerator.MoveNext())
					{
						Layer current33 = enumerator.Current;
						enumerator2 = current33.BatchArray.GetEnumerator();
						try
						{
							while (enumerator2.MoveNext())
							{
								Batch current34 = enumerator2.Current;
								current34.Eventsexe.Clear();
								enumerator3 = current34.Parentevents.GetEnumerator();
								try
								{
									while (enumerator3.MoveNext())
									{
										Event current35 = enumerator3.Current;
										current35.results.Clear();
									}
								}
								finally
								{
								...
								enumerator3 = current34.Sonevents.GetEnumerator();
								try
								{
									while (enumerator3.MoveNext())
									{
										Event current36 = enumerator3.Current;
										current36.results.Clear();
									}
								}
								finally
								{
						...
						enumerator5 = current33.LaseArray.GetEnumerator();
						try
						{
							while (enumerator5.MoveNext())
							{
								Lase current37 = enumerator5.Current;
								current37.Eventsexe.Clear();
								enumerator3 = current37.Parentevents.GetEnumerator();
								try
								{
									while (enumerator3.MoveNext())
									{
										Event current38 = enumerator3.Current;
										current38.results.Clear();
									}
								}
								finally
								{
								...
								enumerator3 = current37.Sonevents.GetEnumerator();
								try
								{
									while (enumerator3.MoveNext())
									{
										Event current39 = enumerator3.Current;
										current39.results.Clear();
									}
								}
								finally
								{
						...
						enumerator6 = current33.CoverArray.GetEnumerator();
						try
						{
							while (enumerator6.MoveNext())
							{
								Cover current40 = enumerator6.Current;
								current40.Eventsexe.Clear();
								enumerator3 = current40.Parentevents.GetEnumerator();
								try
								{
									while (enumerator3.MoveNext())
									{
										Event current41 = enumerator3.Current;
										current41.results.Clear();
									}
								}
								finally
								{
								...
								enumerator3 = current40.Sonevents.GetEnumerator();
								try
								{
									while (enumerator3.MoveNext())
									{
										Event current42 = enumerator3.Current;
										current42.results.Clear();
									}
								}
								finally
								{
					...
					while (enumerator.MoveNext())
					{
						...
						try
						{
							while (enumerator2.MoveNext())
							{
								...
								{
									current44.copys.fx = Player.position.X;
								}
								...
								{
									current44.copys.fy = Player.position.Y;
								}
								if (current44.speedd == -99999f)
								{
									current44.copys.speedd = MathHelper.ToDegrees(Main.Twopointangle(Player.position.X, Player.position.Y, current44.copys.fx, current44.copys.fy));
								}
								if (current44.aspeedd == -99999f)
								{
									current44.copys.aspeedd = MathHelper.ToDegrees(Main.Twopointangle(Player.position.X, Player.position.Y, current44.copys.fx, current44.copys.fy));
								}
								...
								current44.copys.aspeedx = current44.copys.aspeed * (float)Math.Cos((double)MathHelper.ToRadians(current44.copys.aspeedd));
								current44.copys.aspeedy = current44.copys.aspeed * (float)Math.Sin((double)MathHelper.ToRadians(current44.copys.aspeedd));
								current44.copys.speedx = current44.copys.speed * (float)Math.Cos((double)MathHelper.ToRadians(current44.copys.speedd));
								current44.copys.speedy = current44.copys.speed * (float)Math.Sin((double)MathHelper.ToRadians(current44.copys.speedd));
								...
								{
									current44.copys.fdirection = MathHelper.ToDegrees(Main.Twopointangle(current44.x - 4f, current44.y + 16f, current44.copys.fx, current44.copys.fy));
								}
								else if (current44.fdirection == -99999f)
								{
									current44.copys.fdirection = MathHelper.ToDegrees(Main.Twopointangle(Player.position.X, Player.position.Y, current44.copys.fx, current44.copys.fy));
								}
								else if (current44.fdirection == -100000f)
								{
									current44.copys.fdirection = MathHelper.ToDegrees(Main.Twopointangle(current44.fdirections.X, current44.fdirections.Y, current44.copys.fx, current44.copys.fy));
								}
								if (current44.sonaspeedd == -99998f)
								{
									current44.copys.sonaspeedd = MathHelper.ToDegrees(Main.Twopointangle(current44.x - 4f, current44.y + 16f, current44.copys.fx, current44.copys.fy));
								}
								else if (current44.sonaspeedd == -99999f)
								{
									current44.copys.sonaspeedd = MathHelper.ToDegrees(Main.Twopointangle(Player.position.X, Player.position.Y, current44.copys.fx, current44.copys.fy));
								}
								else if (current44.sonaspeedd == -100000f)
								{
									current44.copys.sonaspeedd = MathHelper.ToDegrees(Main.Twopointangle(current44.sonaspeedds.X, current44.sonaspeedds.Y, current44.copys.fx, current44.copys.fy));
								}
								if (current44.head == -100000f)
								{
									current44.copys.head = MathHelper.ToDegrees(Main.Twopointangle(current44.heads.X, current44.heads.Y, current44.copys.fx, current44.copys.fx));
								}
							}
						}
						finally
						...
						try
						{
							while (enumerator5.MoveNext())
							{
								...
								current46.copys.aspeedx = current46.copys.aspeed * (float)Math.Cos((double)MathHelper.ToRadians(current46.copys.aspeedd));
								current46.copys.aspeedy = current46.copys.aspeed * (float)Math.Sin((double)MathHelper.ToRadians(current46.copys.aspeedd));
								current46.copys.speedx = current46.copys.speed * (float)Math.Cos((double)MathHelper.ToRadians(current46.copys.speedd));
								current46.copys.speedy = current46.copys.speed * (float)Math.Sin((double)MathHelper.ToRadians(current46.copys.speedd));
								if (current46.fdirection == -99999f)
								{
									current46.copys.fdirection = MathHelper.ToDegrees(Main.Twopointangle(Player.position.X, Player.position.Y, current46.copys.x - 4f, current46.copys.y + 16f));
								}
								else if (current46.fdirection == -100000f)
								{
									current46.copys.fdirection = MathHelper.ToDegrees(Main.Twopointangle(current46.fdirections.X, current46.fdirections.Y, current46.copys.x - 4f, current46.copys.y + 16f));
								}
								if (current46.sonaspeedd == -99998f)
								{
									current46.copys.sonaspeedd = MathHelper.ToDegrees(Main.Twopointangle(current46.x - 4f, current46.y + 16f, current46.copys.x - 4f, current46.copys.y + 16f));
								}
								else if (current46.sonaspeedd == -99999f)
								{
									current46.copys.sonaspeedd = MathHelper.ToDegrees(Main.Twopointangle(Player.position.X, Player.position.Y, current46.copys.x - 4f, current46.copys.y + 16f));
								}
								else if (current46.sonaspeedd == -100000f)
								{
									current46.copys.sonaspeedd = MathHelper.ToDegrees(Main.Twopointangle(current46.sonaspeedds.X, current46.sonaspeedds.Y, current46.copys.x - 4f, current46.copys.y + 16f));
								}
							}
						}
						finally
						...
						try
						{
							while (enumerator6.MoveNext())
							{
								...
								current48.copys.aspeedx = current48.copys.aspeed * (float)Math.Cos((double)MathHelper.ToRadians(current48.copys.aspeedd));
								current48.copys.aspeedy = current48.copys.aspeed * (float)Math.Sin((double)MathHelper.ToRadians(current48.copys.aspeedd));
								current48.copys.speedx = current48.copys.speed * (float)Math.Cos((double)MathHelper.ToRadians(current48.copys.speedd));
								current48.copys.speedy = current48.copys.speed * (float)Math.Sin((double)MathHelper.ToRadians(current48.copys.speedd));
							}
						}
						finally
						{
						...
						try
						{
							while (enumerator7.MoveNext())
							{
								...
								current50.copys.aspeedx = current50.copys.aspeed * (float)Math.Cos((double)MathHelper.ToRadians(current50.copys.aspeedd));
								current50.copys.aspeedy = current50.copys.aspeed * (float)Math.Sin((double)MathHelper.ToRadians(current50.copys.aspeedd));
								current50.copys.speedx = current50.copys.speed * (float)Math.Cos((double)MathHelper.ToRadians(current50.copys.speedd));
								current50.copys.speedy = current50.copys.speed * (float)Math.Sin((double)MathHelper.ToRadians(current50.copys.speedd));
							}
						}
						finally
						{
						...
						try
						{
							while (enumerator8.MoveNext())
							{
								...
								current51.copys.aspeedx = current51.copys.aspeed * (float)Math.Cos((double)MathHelper.ToRadians(current51.copys.aspeedd));
								current51.copys.aspeedy = current51.copys.aspeed * (float)Math.Sin((double)MathHelper.ToRadians(current51.copys.aspeedd));
								current51.copys.speedx = current51.copys.speed * (float)Math.Cos((double)MathHelper.ToRadians(current51.copys.speedd));
								current51.copys.speedy = current51.copys.speed * (float)Math.Sin((double)MathHelper.ToRadians(current51.copys.speedd));
							}
						}
						finally
						{

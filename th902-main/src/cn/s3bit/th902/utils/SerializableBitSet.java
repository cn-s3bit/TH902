...
public class SerializableBitSet {
	...
	public SerializableBitSet (int nbits) {
	...
	public void and (SerializableBitSet other) {
	 ...
	 * 
	 * @param other a bit set */
	public void andNot (SerializableBitSet other) {
	 ...
	 * value true.
	 * @param other a bit set */
	public void or (SerializableBitSet other) {
		int commonWords = Math.min(bits.length, other.bits.length);
		for (int i = 0; commonWords > i; i++) {
			bits[i] |= other.bits[i];
		}
	 ...
	 * </ul>
	 * @param other */
	public void xor (SerializableBitSet other) {
		int commonWords = Math.min(bits.length, other.bits.length);
	...
	public boolean intersects (SerializableBitSet other) {
		long[] bits = this.bits;
	...
	public boolean containsAll (SerializableBitSet other) {
		long[] bits = this.bits;
		long[] otherBits = other.bits;
	...
	public void loadFrom(DataInput input) throws IOException {
		bits = new long[input.readInt()];
		for (int i = 0; i < bits.length; i++) {
	...
	public boolean equals(Object obj) {
		...
		SerializableBitSet other = (SerializableBitSet) obj;
		long[] otherBits = other.bits;
